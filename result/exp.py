...
demos = {
  ...
  "gui": ["button_demo", "checkbox_demo", "colorchooser_demo", "combobox_demo", "custom_icon_demo", "filechooser_demo", "toolbar_demo", "menu_demo", "splitpane_divider_demo", "text_field_demo"]
}
...
def main():
  ...
  opts.extend(["--slv-ntimes", str(1024*64)])
