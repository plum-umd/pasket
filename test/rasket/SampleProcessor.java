...
class SampleProcessor {
    public static void generate(String name, File f) throws IOException, InterruptedException{
        ArrayList<String> command = new ArrayList(Arrays.asList("java", "-javaagent:../lib/loggeragent.jar=time", "-cp", "rasket/bin", "rasket.test." + name));
	...
	/*
        ...
        l = l.replaceAll("javax.swing.text.Document.addDocumentListener", "javax.swing.text.AbstractDocument.addDocumentListener");
