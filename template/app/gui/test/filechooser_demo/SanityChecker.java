...
class SwingEventHandler implements EventHandler {
    AdaptedFileChooserDemo demo;
    public SwingEventHandler(AdaptedFileChooserDemo afcd) {
        demo = afcd;
    }
    ...
    private String getCommand(String command) {
        if (command.equals("$Open")) return "Open a File...";
	else if (command.equals("$Save")) return "Save a File...";
        else return null;
    }
 
    private JButton getButton(String command) {
        if (command.equals("$Open")) return demo.openButton;
	else if (command.equals("$Save")) return demo.saveButton;
        else return null;
    }
...
public class SanityChecker {
    ...
    public static SwingEventHandler getEventHandler(AdaptedFileChooserDemo afcd) {
        if (seh == null)
            seh = new SwingEventHandler(afcd);
        return seh;
    }
    ...
    IOException, InterruptedException {
        ...
        File temp = new File("temp_filechooser_demo.txt");
