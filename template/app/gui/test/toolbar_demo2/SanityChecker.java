...
class SwingEventHandler implements EventHandler {
    AdaptedToolBarDemo2 demo;
    public SwingEventHandler(AdaptedToolBarDemo2 abd) {
        demo = abd;
    }
    ...
    private JButton getButton(String command) {
        if (command.equals("$Previous")) return demo.b1;
        else if (command.equals("$Up")) return demo.b2;
        else if (command.equals("$Next")) return demo.b3;
        else if (command.equals("$Other")) return demo.b4;
        else return null;
    }
}
...
public class SanityChecker {
    ...
    public static SwingEventHandler getEventHandler(AdaptedToolBarDemo2 abd) {
        if (seh == null)
    ...
    IOException, InterruptedException {
        ...
        File temp = new File("temp_toobar_demo2.txt");
