...
class SwingEventHandler implements EventHandler {
    AdaptedCustomIconDemo demo;
    public SwingEventHandler(AdaptedCustomIconDemo abd) {
        demo = abd;
    }
    ...
    private String getCommand(String command) {
        if (command.equals("$Disable")) return "disable";
        else if (command.equals("$Enable")) return "enable";
        else return null;
    }

    private JButton getButton(String command) {
        if (command.equals("$Disable")) return demo.b1;
...
public class SanityChecker {
    ...
    public static SwingEventHandler getEventHandler(AdaptedCustomIconDemo abd) {
        if (seh == null)
    ...
    IOException, InterruptedException {
        ...
        File temp = new File("temp_custom_icon_demo.txt");
