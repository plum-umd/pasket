...
class SwingEventHandler implements EventHandler {
    AdaptedButtonHtmlDemo demo;
    public SwingEventHandler(AdaptedButtonHtmlDemo abd) {
        demo = abd;
    }
    ...
    private JButton getButton(String command) {
        System.out.println("xxxxx" + command);
...
public class SanityChecker {
    ...
    public static SwingEventHandler getEventHandler(AdaptedButtonHtmlDemo abd) {
        if (seh == null)
