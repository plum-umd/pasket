...
class SwingEventHandler implements EventHandler {
    AdaptedToolBarDemo demo;
    public SwingEventHandler(AdaptedToolBarDemo abd) {
        demo = abd;
    }
...
public class SanityChecker {
    ...
    public static SwingEventHandler getEventHandler(AdaptedToolBarDemo abd) {
        if (seh == null)
    ...
    IOException, InterruptedException {
        ...
        File temp = new File("temp_toolbar_demo.txt");
