...
class SwingEventHandler implements EventHandler {
    AdaptedCheckBoxDemo demo;
    public SwingEventHandler(AdaptedCheckBoxDemo abd) {
        demo = abd;
    }
    ...
    private JCheckBox getCheckBox(String command) {
...
public class SanityChecker {
    ...
    public static SwingEventHandler getEventHandler(AdaptedCheckBoxDemo abd) {
        if (seh == null)
