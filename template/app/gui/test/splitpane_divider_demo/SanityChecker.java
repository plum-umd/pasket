...
class SwingEventHandler implements EventHandler {
    AdaptedSplitPaneDividerDemo demo;
    public SwingEventHandler(AdaptedSplitPaneDividerDemo abd) {
        demo = abd;
    }
...
public class SanityChecker {
    ...
    public static SwingEventHandler getEventHandler(AdaptedSplitPaneDividerDemo abd) {
        if (seh == null)
    ...
    IOException, InterruptedException {
        ...
        File temp = new File("temp_splitpane_divider_demo.txt");
